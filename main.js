...
document.getElementById("drawingtobedrawn").innerHTML = "drawing to Be Drawn: "+Element_of_array;
...
answer_holder = "";
score = 0;
drawing = Element_of_array;

function draw(){
    check_drawing();
    if(drawn_drawing == drawing){
        answer_holder = "set";
        score = score+1;
...
function updateCanvas(){
    ...
    document.getElementById("drawingtobedrawn").innerHTML = "drawing To Be Drawn: "+sketch;
}
